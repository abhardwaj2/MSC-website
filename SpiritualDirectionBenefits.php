...
<head>
    ...
    <title>Spiritual Direction Benefits</title>
...
<img src="images/background14.jpg" alt="background image" class="background" />
<div class="content-container">
    <nav>
        <ul id="navigation">
            <li><a href="SpiritualDirectionOverview.php">Overview</a></li>
            <li><a href="SpiritualDirectionBenefits.php" style="background-color: rgb(98, 100, 167); color: white;">Benefits</a></li>
            <li><a href="SpiritualDirectionEndorsements.php">Endorsements</a></li>
        </ul>
        <hr>
    </nav>
    ...
    <ul>
        ...
        <li>Connect with and develop greater awareness and sensitivity to important religious/spiritual experiences.</li>
    ...
    <ul>
        ...
        <ul>
            <li>Learn fresh processes for spiritual growth to develop and integrate life experiences.</li>
            <li>Broaden perspectives and intuitive abilities.</li>
        </ul>
        <li>Directees: Greater Participation Possible</li>
        <ul>
            <li>Uncover and develop issues and experiences.</li>
            <li>Integrate selected exercises into sessions.</li>
        </ul>
        <li>Spiritual Direction Sessions: Greater Depth </li>
        <ul>
            <li>Sessions can move to a deeper level.</li>
            <li>Directees can gain insights and clarity.</li>
        </ul>
        <li>Post-session: Life-Long Tool for Spiritual-Growth</li>
    </ul>
